class SqlData {
    ...
    `SELECT sq.*, a.ACCOUNT_USERNAME
    FROM (SELECT TO_CHAR(fe.FORM_EVENT_OCCURRED, 'DD-Mon-YYYY HH24:MI') as "FORM_EVENT_OCCURRED", fet.FORM_EVENT_TYPE_NAME, f.FORM_ORG_UNIT_NAME, fe.FORM_EVENT_CREATOR_ID
        ...
        ORDER BY fe.FORM_EVENT_OCCURRED ASC) sq
    LEFT OUTER JOIN ACCOUNT a ON sq.FORM_EVENT_CREATOR_ID = a.ACCOUNT_ID`
}
